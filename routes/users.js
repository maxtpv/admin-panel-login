...
const { findAllUsers, createUser, updateUser, checkEmptyNameEmailAndPassword, deleteUser, hashPassword } = require('../middlewares/users')
...
userRouter.put('/users/:id', checkEmptyNameEmailAndPassword, checkAuth, updateUser, sendUserUpdated)
